      ...
      <div className="max-w-[1280px] mx-auto">
        <div className="text-center mb-4">
          ...
          <p className="max-w-2xl mx-auto text-gray-600 text-lg">
            বন্ধুমহল সাসাইটি ২০০৯ এর গঠনতন্ত্র এবং নিয়মাবলী। আমাদের সংগঠনের
            মূলনীতি ও কার্যপ্রণালী সম্পর্কে জানুন।
          </p>
        </div>
              ...
              <div className="relative z-10 rounded-lg overflow-hidden shadow-xl">
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#284a4e]/80 to-transparent p-6">
                  <p className="text-white font-medium">
                    বন্ধুমহল সাসাইটির গঠনতন্ত্র ও নিয়মাবলী
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700">
                    বন্ধুমহল সাসাইটি ২০০৯ (BMS) - একটি বিজনেস প্ল্যাটফর্ম
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    গণতান্ত্রিক জনকল্যাণমুখী সংগঠন।
                  </p>
                </div>
